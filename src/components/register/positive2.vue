<template>
  <div>
    ...
    <step :step='num'></step>
      <div class="fget-num">
        <div class="fget-ul">
          <p class="first-li first-li-idcar">上传授权委托书：</p>
          <el-upload
            class="upload"
        ...
        <div class="tellinfo">授权书示例</div>
      </div>
      <div class="nextBox">
        <mt-button type="primary" size="large" class="btn" @click="nextTep">注册</mt-button>
      </div>
    </div>
  </div>
</template>
...
import two from "@/assets/img/information3x.png";
export default {
  name: "Positive",
  data() {
    let that = this;
